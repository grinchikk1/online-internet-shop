...
const Review = ({ name, date, review, rating, onDelete }) => {
  ...
  return (
    <>
      <ListItem alignItems="flex-start" sx={{ padding: 0, marginBottom: "50px", maxWidth: "auto" }}>
        ...
        <ListItemText 
          primary={
            ...
            <Typography sx={{ display: "inline", marginLeft: "10px" }} component="span" variant="body2" color="text.primary">
                {date}
                          </Typography>
            ...
            <Rating name="read-only" value={rating} readOnly sx={{marginTop: "5px"}} />
              <Typography component="span" variant="body1" color="text.primary" sx={{ display: "block", fontSize: "16px", fontWeight: 400, lineHeight: "27px", wordWrap: "break-word" }}>
                {review}
            </Typography>
            {/* <ModeEditIcon /> */}
